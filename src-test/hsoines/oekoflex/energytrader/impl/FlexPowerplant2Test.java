...
//        testBalancingMarketOperator.makeBid(flexpowerplant).checkPowerPos(33.3333f, 2641.6064f).checkPowerNeg(66.6666f, 1362.4f).notifyRatePos(1).notifyRateNeg(0);//todo: preis pr�fen
//
//    }
//
//    @Test
