...
public class EnergySlotListImplTest {
    ...
    public void testSlotAssignedException() {
        energySlotList.addAssignedQuantity(date0, Market.EOM_MARKET, 10f, 10f, 500, 1f, BidType.ENERGY_DEMAND);
        energySlotList.addAssignedQuantity(date0, Market.EOM_MARKET, 10f, 10f, 500, 1f, BidType.ENERGY_DEMAND);
        energySlotList.addAssignedQuantity(date0, Market.EOM_MARKET, 10f, 10f, 1, 1f, BidType.ENERGY_DEMAND);
    }
